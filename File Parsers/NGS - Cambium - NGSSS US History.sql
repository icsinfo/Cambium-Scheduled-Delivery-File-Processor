SELECT
    ...
    ,CASE student_data_source.{col_21}
        ...
        ELSE NULL
    END AS LATE_NINETEENTH_AND_EARLY_TWENTIETH_CENTURY
    ,CASE student_data_source.{col_22}
        WHEN 'Above the Standard' THEN '3'
        WHEN 'At/Near the Standard' THEN '2'
        WHEN 'Below the Standard' THEN '1'
        ELSE NULL
    END AS GLOBAL_MILITARY_POLITICAL_AND_ECONOMIC_CHALLENGES
    ,CASE student_data_source.{col_23}
        WHEN 'Above the Standard' THEN '3'
        WHEN 'At/Near the Standard' THEN '2'
        WHEN 'Below the Standard' THEN '1'
        ELSE NULL
    END AS THE_UNITED_STATES_AND_THE_DEFENSE_OF_INTERNATIONAL_PEACE

SELECT
    ...
    ,CASE student_data_source.{col_21}
        ...
        ELSE NULL
    END AS ORIGINS_AND_PURPOSES_OF_LAW_AND_GOVERNMENT
    ,CASE student_data_source.{col_22}
        WHEN 'Above the Standard' THEN '3'
        WHEN 'At/Near the Standard' THEN '2'
        WHEN 'Below the Standard' THEN '1'
        ELSE NULL
    END AS ROLES_RIGHTS_AND_RESPONSIBILITIES_OF_CITIZENS
    ,CASE student_data_source.{col_23}
        WHEN 'Above the Standard' THEN '3'
        WHEN 'At/Near the Standard' THEN '2'
        WHEN 'Below the Standard' THEN '1'
        ELSE NULL
    END AS GOVERNMENT_POLICIES_AND_POLITICAL_PROCESSES
    ,CASE student_data_source.{col_24}
        WHEN 'Above the Standard' THEN '3'
        WHEN 'At/Near the Standard' THEN '2'
        WHEN 'Below the Standard' THEN '1'
        ELSE NULL
    END AS ORGANIZATION_AND_FUNCTION_OF_GOVERNMENT

SELECT
    ...
    ,CASE student_data_source.{col_22}
        ...
        ELSE NULL
    END AS NUMBER_SENSE_AND_ADDITIVE_REASONING
    ,CASE student_data_source.{col_23}
        WHEN 'Above the Standard' THEN '3'
        WHEN 'At/Near the Standard' THEN '2'
        WHEN 'Below the Standard' THEN '1'
        ELSE NULL
    END AS NUMBER_SENSE_AND_MULTIPLICATIVE_REASONING
    ,CASE student_data_source.{col_24}
        WHEN 'Above the Standard' THEN '3'
        WHEN 'At/Near the Standard' THEN '2'
        WHEN 'Below the Standard' THEN '1'
        ELSE NULL
    END AS FRACTIONAL_REASONING
    ,CASE student_data_source.{col_25}
        WHEN 'Above the Standard' THEN '3'
        WHEN 'At/Near the Standard' THEN '2'
        WHEN 'Below the Standard' THEN '1'
        ELSE NULL
    END AS GEOMETRIC_REASONING_MEASUREMENT_AND_DATA_ANALYSIS_AND_PROBABILITY

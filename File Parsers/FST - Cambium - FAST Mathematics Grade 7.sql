SELECT
    ...
    END AS test_level
    ,CASE
        -- Check if the column contains anything that is NOT a digit
    ...
    ,CASE student_data_source.{col_22}
        ...
        ELSE NULL
    END AS NUMBER_SENSE_AND_OPERATIONS_AND_ALGEBRAIC_REASONING
    ,CASE student_data_source.{col_23}
        WHEN 'Above the Standard' THEN '3'
        WHEN 'At/Near the Standard' THEN '2'
        WHEN 'Below the Standard' THEN '1'
        ELSE NULL
    END AS PROPORTIONAL_REASONING_AND_RELATIONSHIPS
    ,CASE student_data_source.{col_24}
        WHEN 'Above the Standard' THEN '3'
        WHEN 'At/Near the Standard' THEN '2'
        WHEN 'Below the Standard' THEN '1'
        ELSE NULL
    END AS GEOMETRIC_REASONING
    ,CASE student_data_source.{col_25}
        WHEN 'Above the Standard' THEN '3'
        WHEN 'At/Near the Standard' THEN '2'
        WHEN 'Below the Standard' THEN '1'
        ELSE NULL
    END AS DATA_ANALYSIS_AND_PROBABILITY
